# Generated by Django 3.0.3 on 2021-01-02 15:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default.gif', upload_to='profile_pic')),
                ('description', models.TextField(blank=True, null=True)),
                ('Gender', models.CharField(choices=[('male', 'Male'), ('female', 'Famale')], max_length=300, null=True)),
                ('Role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher')], max_length=300, null=True)),
